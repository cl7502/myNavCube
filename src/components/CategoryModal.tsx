...
function IconLibrarySelector({ prefix, iconSet, onSelect, currentIcon, searchQuery }: { prefix: string; iconSet: string; onSelect: (icon: string) => void; currentIcon: string; searchQuery: string }) {
  const icons = iconLibraryIcons[iconSet] || [];
  ...
  return (
    <div className="h-44 overflow-y-auto border border-gray-200 rounded p-2">
      <div className="grid grid-cols-8 gap-1">
        {filteredIcons.map((iconName) => (
          ...
          >
            {brokenIcons.has(iconName) ? (
              ...
              <img
                src={`https://api.iconify.design/${prefix}/${iconName}.svg?width=18&height=18`}
                alt={iconName}
                className="w-4 h-4"
            ...
            <div>
              ...
              <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="border border-gray-200 rounded">
                <Tabs.List className="flex border-b border-gray-200 bg-gray-50 overflow-x-auto">
                  <Tabs.Trigger value="iconify" className="px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 whitespace-nowrap">
                    Iconify
                  </Tabs.Trigger>
                  <Tabs.Trigger value="lucide" className="px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 whitespace-nowrap">
                    Lucide
                  </Tabs.Trigger>
                  <Tabs.Trigger value="iconoir" className="px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 whitespace-nowrap">
                    Iconoir
                  </Tabs.Trigger>
                  <Tabs.Trigger value="phosphor" className="px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 whitespace-nowrap">
                    Phosphor
                  </Tabs.Trigger>
                  <Tabs.Trigger value="heroicons" className="px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:bg-white data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 whitespace-nowrap">
                    Heroicons
                  </Tabs.Trigger>
                </Tabs.List>
                ...
                <div className="p-3">
                  ...
                  <Tabs.Content value="lucide">
                    <IconLibrarySelector prefix="lucide" iconSet="lucide" onSelect={setIcon} currentIcon={icon} searchQuery={searchQuery} />
                  </Tabs.Content>

                  <Tabs.Content value="iconoir">
                    <IconLibrarySelector prefix="iconoir" iconSet="iconoir" onSelect={setIcon} currentIcon={icon} searchQuery={searchQuery} />
                  </Tabs.Content>

                  <Tabs.Content value="phosphor">
                    <IconLibrarySelector prefix="phosphor" iconSet="phosphor" onSelect={setIcon} currentIcon={icon} searchQuery={searchQuery} />
                  </Tabs.Content>

                  <Tabs.Content value="heroicons">
                    <IconLibrarySelector prefix="heroicons" iconSet="heroicons" onSelect={setIcon} currentIcon={icon} searchQuery={searchQuery} />
                  </Tabs.Content>
                </div>
              </Tabs.Root>
